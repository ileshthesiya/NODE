...
-- C. select * from client_master where city in("Banglore","Manglore");
-- C. select * from client_master where city="Banglore" or city="Bombay";

-- D. select * from client_master where baldue>10000;

-- E. select * from sales_order where orderdate between "2004-06-01" and "2004-06-30";
...
-- H. alter table product_master add new_price int;
